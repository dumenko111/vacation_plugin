...
class Tabs {
    ...
    _getPaneId(control) {//отримуємо значення з href
        return control.getAttribute('href').slice(1);
    }

    _getPaneById(id) {
        return this._refs.panes.querySelector(`#${id}`);//шукаємо по Id елемент в якого айдішник зі значенням з href 
    }
    }


const tabs1 = new Tabs({
    rootSelector: '#tabs-1',//передаємо в клас селектор
